...
public class EventVerification extends BaseVerification {
    ...
    public void checkEvent() {
        ...
        softAssert().as("event [" + context.getEventName() + "]").assertThat("BB").isEqualTo("XX");
    }
    ...
    public void verifyRange() {
        ...
        SleepUtil.sleep(1000);
        softAssert().as("range [" + context.getEventName() + "]").assertThat("10").isEqualTo("10");
    }
    ...
    public void verifyLimit() {
        ...
        SleepUtil.sleep(1000);
        softAssert().as("limit [" + context.getEventName() + "]").assertThat("99").isEqualTo("100");
    }
}
